package com.ceme.crm.configurations;
...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        newCustomer = new CustomerModel("Rogers", "Nelson", "Rogers.Nelson@Paisley.com");
        customerRepository.insert(newCustomer);

        newCustomer = new CustomerModel("Bob", "Masrley", "bob.marley@jamaica.com");
        customerRepository.insert(newCustomer);

        newCustomer = new CustomerModel("Paul", "Atrades", "paul.atrades@dune.com");
        customerRepository.insert(newCustomer);

        System.out.println("\u001B[31m" + "Initialized data.." + "\u001B[0m");
